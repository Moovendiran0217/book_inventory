<div class="container bg-white p-5">
    <h2 class="text-center fw-bold mb-5">Sales Report</h2>
    ...
    <?php if (!empty($salesReports) && count($salesReports)): ?>
                ...
                <tbody>
                    <?php foreach ($salesReports as $report): ?>
                        <tr>
                            ...
                            <td><?= h($report->total_amount) ?></td>
                            <td><?= h($report->total_order) ?></td>
                            <td>
                                <?= $this->Html->link(
                                    'View',
                                    ['action' => 'viewSales', $report->report_id],
                                    ['class' => 'btn btn-primary btn-sm']
                                ) ?>

                                <?= $this->Html->link(
                                    'Download Report',
                                    ['action' => 'viewSales', $report->report_id, '?' => ['pdf' => 1]],
                                    [
    ...
    <?php else: ?>
        <div class="alert alert-warning">No sales reports found.</div>
    <?php endif; ?>
</div>